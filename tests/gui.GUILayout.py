...
lyt = pgt.gui.GUILayout({
    "hi_button": pgt.gui.Button(
        ...
        pos_point=pgt.CC,
        anchor_point=pgt.CC,
        image=pgt.surface_filled((80, 40), pgt.R(50)),
        func=print,
        func_args=["Hi :)"],
        ...
        hint_bg=pgt.Element(
            pos=0,
            size=(150, 40),
            image=pgt.surface_filled((150, 40), pgt.G(50))
        ),
    ...
    "other_button": pgt.gui.Button(
        ...
        pos_point=pgt.DR,
        anchor_point=pgt.DR,
        image=pgt.surface_filled((80, 40), pgt.R(100)),
        func=print,
        func_args=["Hi2 :)"],
        text_label=pgt.gui.Label(
            pos=0,
        ...
        hint_bg=pgt.Element(
            pos=0,
            size=(150, 40),
            image=pgt.surface_filled((150, 40), pgt.G(100))
        ),
        hint_label=pgt.gui.Label(
            pos=0,
            pos_point=pgt.CC,
    ...
    "layout_in_layout": pgt.gui.GUILayout(
        {
            "hi_button": pgt.gui.Button(
                ...
                pos_point=pgt.CC,
                anchor_point=pgt.CC,
                image=pgt.surface_filled((80, 40), pgt.B(50)),
                func=print,
                func_args=["Hii :)"],
                text_label=pgt.gui.Label(
                    pos=0,
                ...
                hint_bg=pgt.Element(
                    pos=0,
                    size=(150, 40),
                    image=pgt.surface_filled((150, 40), pgt.B(50))
                ),
                hint_label=pgt.gui.Label(
                    pos=0,
                    pos_point=pgt.CC,
            ...
            "other_button": pgt.gui.Button(
                ...
                pos_point=pgt.DR,
                anchor_point=pgt.DR,
                image=pgt.surface_filled((80, 40), pgt.B(100)),
                func=print,
                func_args=["Hii2 :)"],
                text_label=pgt.gui.Label(
                    pos=0,
                ...
                hint_bg=pgt.Element(
                    pos=0,
                    size=(150, 40),
                    image=pgt.surface_filled((150, 40), pgt.B(100))
                ),
                hint_label=pgt.gui.Label(
                    pos=0,
                    pos_point=pgt.CC,
